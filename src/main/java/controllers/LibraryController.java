...
//	private LibraryShadowNode shadowIcon = null;
	...
	private static LibraryController self;
...
//	private EquipmentType targetType;
	...
	public void initialize(){
		library_pane = LibraryDialog.get().getLibPane();
		rootPane = GUI.get();
//		buildDragHandlers();
...
//	}
	...
	public static LibraryController get() { if(self==null) self = new LibraryController(); return self; }
